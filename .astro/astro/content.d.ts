...
declare module 'astro:content' {
	...
	type ContentEntryMap = {
		"articles": {
"barstool_relationship_model.mdx": {
	id: "barstool_relationship_model.mdx";
  slug: "barstool_relationship_model";
  body: string;
  collection: "articles";
...
"personal_theory_of_learning.md": {
	id: "personal_theory_of_learning.md";
  slug: "personal_theory_of_learning";
  body: string;
  collection: "articles";
  data: InferEntrySchema<"articles">
} & { render(): Render[".md"] };
